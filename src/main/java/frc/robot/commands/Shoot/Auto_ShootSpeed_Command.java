...
public class Auto_ShootSpeed_Command extends CommandBase {
  ...
  public void initialize() {
    i = 0;
    Robot.shooter.setshooterSpeed((.00081*SmartDashboard.getNumber("Target Distance", 0)) + .56058);
    SmartDashboard.putNumber("Auto Shooter Speed", (.00081*SmartDashboard.getNumber("Target Distance", 0)) + .56058);
  }
  ...
  public void execute() {
    ...
    if(i > 75){
      ...
      Robot.intake.runMiddleMotor(.45);
    } else if (i > 250) {
